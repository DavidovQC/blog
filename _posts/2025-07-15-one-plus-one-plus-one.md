...
Conquered by clever proofs like the one below:
...
{\large Adult: $\textbf{Answer}_1$ - Child: But why?}

    {Adult: $\textbf{Answer}_2$ - Child: But why?}

    {\footnotesize Adult: $\textbf{Answer}_3$ - Child: But why?}

    {\tiny Adult: $\textbf{Answer}_4$ - Child: But why?}
